...
import InventarisKantor.FormBarangKeluar_diana;
/**
 *
 * @author DELL
 */
public class PopupBarangmasuk_diana extends javax.swing.JFrame {
    DefaultTableModel model;
    
    public FormBarangKeluar_diana masuk = null;
    /**
     * Creates new form PopupBarangmasuk_diana
     */
    public PopupBarangmasuk_diana() {
        initComponents();
    ...
    private void tabel_dataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabel_dataMouseClicked
        ...
        masuk.kdinv = tabel_data.getValueAt(index, 0).toString();
        masuk.kdbrng = tabel_data.getValueAt(index, 1).toString();
        masuk.nmbrng = tabel_data.getValueAt(index, 2).toString();
        masuk.kat = tabel_data.getValueAt(index, 3).toString();
        masuk.merks = tabel_data.getValueAt(index, 4).toString();
        masuk.kdlok = tabel_data.getValueAt(index, 6).toString();
        masuk.nmlok = tabel_data.getValueAt(index, 7).toString();
        masuk.itemTerpilih();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopupBarangmasuk_diana.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopupBarangmasuk_diana().setVisible(true);
            }
        });
    }
